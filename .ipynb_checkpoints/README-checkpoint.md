# Udacity Nanodegree: Machine Learning with PyTorch, Project 2: CIFAR10 Image Classifier

## Objective

Perform image classification on the standard CIFAR10 dataset, using a less traditional RNN-based image classification architecture. The minimum validation and testing accuracy to be achieved is 70%.
...
1) Unzip the submitted 'udacity_ai_programming_project_2.zip' file into a desired working directory/cloud storage like Google Drive.
...
![Command Line Application Final Output](./udacity_ai_programming_project_2/final_command_line_output.png)
